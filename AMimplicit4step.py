...
for i in range (3,n):
	c= y[i]+( h/24)*(55*f(x[i],y[i])-59*f(x[i-1],y[i-1])+37*f(x[i-2],y[i-2])-9*f(x[i-3],y[i-3]))
	y[i+1]=y[i]+( h/720)*(646*f(x[i],y[i])-264*f(x[i-1],y[i-1])+106*f(x[i-2],y[i-2])-19*f(x[i-3],y[i-3])+251*f(x[i+1],c))
